...
class PotionSmall(Sprite):
    ...
    def __init__(
        ...
        position,
        screen,
        path: str = 'advancing_hero/images/sprites/potions/potion_small/',
    ) -> None:
    ...
    def player_collision(self, player):
        if self.rect.colliderect(player.rect) and not self.caught:
            ...
            self.caught = True
            self.buff_duration = 1000
            player.size_effect = 'small'
