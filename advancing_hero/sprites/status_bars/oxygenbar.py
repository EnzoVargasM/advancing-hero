...
class OxygenBar(Sprite):
    ...
    def __init__(
        ...
        self.initial_image = pygame.transform.scale(self.image, (self.initial_width, 10))
    ...
    def update(self):
        ...
        self.image = pygame.transform.scale(self.initial_image, (round(self.initial_width * current_oxygen / max_oxygen), 10))
